# Guía de instalación del proyecto Ionic-Angular
...
npm install 
```
## Levantar el frontend de l proyecto

El frontend del proyeto está construido en Ionic con Angular y Tailwind, para ejecutar el frontend debes ejecutar el siguiente comando:
